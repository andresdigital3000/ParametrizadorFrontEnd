  ...
  render(){
    ...
    return(
        <nav aria-label="Paginar">
          <If condition = {this.props.state.txtBuscarParametro.trim()==''}>
            <ul className="pagination">
              ...
              <If condition = {this.props.state.paginador.length > 10}>
                  <li key='1' className={classBotonf}>
                      <a className="page-link" onClick={() => this.props.moverPaginaParametros(1)}>
                        1&laquo;
                  ...
                  <li key={this.props.state.paginador.length} className={classBotonl}>
                      <a className="page-link" onClick={() => this.props.moverPaginaParametros(this.props.state.paginador.length)}>
