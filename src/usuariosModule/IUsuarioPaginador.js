...
import { moverPaginaUsuarios } from '../actions/Actions';

class IUsuarioPaginador extends React.Component{
  constructor(){
    super(...arguments)
  }
  ...
  render(){
    ...
    return(
        <nav aria-label="Paginar">
          <If condition = {this.props.state.txtBuscarUsuarios.trim()==''}>
            <ul className="pagination">
              <If condition = {this.props.state.paginador.length <= 10}>
                <li className="page-item">
                  <a className="page-link" onClick={() => this.props.moverPaginaUsuarios(this.props.state.paginaActual-1)} aria-label="Previous">
                ...
                {this.props.state.paginador.map(function(currentValue,index,array){
                  ...
                  return(
                      <li key={currentValue.id} className={classBoton}>
                        <a className="page-link" onClick={() => this.props.moverPaginaUsuarios(currentValue.id)}>
                          {currentValue.id}
                ...
                <li className="page-item">
                  <a className="page-link" onClick={() => this.props.moverPaginaUsuarios(this.props.state.paginaActual+1)} aria-label="Next">
              ...
              <If condition = {this.props.state.paginador.length > 10}>
                  <li key='1' className={classBotonf}>
                      <a className="page-link" onClick={() => this.props.moverPaginaUsuarios(1)}>
                        1&laquo;
                  ...
                  <li key={this.props.state.paginador.length} className={classBotonl}>
                      <a className="page-link" onClick={() => this.props.moverPaginaUsuarios(this.props.state.paginador.length)}>
