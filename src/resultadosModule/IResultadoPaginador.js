...
import { moverPaginaResultados } from '../actions/Actions';

class IResultadoPaginador extends React.Component{
  constructor(){
    super(...arguments)
  }
            ...
            <ul className="pagination">
              <If condition = {this.props.state.paginador.length <= 10}>
                <li className="page-item">
                  <a className="page-link" onClick={() => this.props.moverPaginaResultados(this.props.state.paginaActual-1)} aria-label="Previous">
                ...
                {this.props.state.paginador.map(function(currentValue,index,array){
                  ...
                  return(
                      <li key={currentValue.id} className={classBoton}>
                        <a className="page-link" onClick={() => this.props.moverPaginaResultados(currentValue.id)}>
                          {currentValue.id}
                ...
                <li className="page-item">
                  <a className="page-link" onClick={() => this.props.moverPaginaResultados(this.props.state.paginaActual+1)} aria-label="Next">
              ...
              <If condition = {this.props.state.paginador.length > 10}>
                  <li key='1' className={classBotonf}>
                      <a className="page-link" onClick={() => this.props.moverPaginaResultados(1)}>
                        1&laquo;
                  ...
                  <li key={this.props.state.paginador.length} className={classBotonl}>
                      <a className="page-link" onClick={() => this.props.moverPaginaResultados(this.props.state.paginador.length)}>
