...
import { cargarComboConciliacionesEjecución, updateEjecucion, getStatusEjecucionConciliacion, doEjecutarConciliacion, doCancelarConciliacion } from '../actions/Actions';
...
class IEjecucion extends React.Component{
  ...
  componentWillMount(){
    this.props.cargarComboConciliacionesEjecución()
  }
...
export default connect (mapStateToProps,{
  cargarComboConciliacionesEjecución, updateEjecucion, getStatusEjecucionConciliacion, doEjecutarConciliacion, doCancelarConciliacion
})(IEjecucion)
